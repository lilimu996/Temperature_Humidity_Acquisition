...
void uart2_init(void)
{
	...
	PORT_Init((PORT_TypeDef *)RS485_RX_PORT, RS485_RX_PIN, PORTB_PIN13_UART2_RX, 1);	//RS485_RX配置为UART2输入引脚
	PORT_Init((PORT_TypeDef *)RS485_TX_PORT, RS485_TX_PIN, PORTB_PIN11_UART2_TX, 0);	//GPIOM.1配置为UART0输出引脚
