 ...
 *      TYPEDEFS
 **********************/
extern uint32_t LCD_Buffer[1024*600] __attribute__((section(".SDRAM1")));
...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_3_1[1024 * 600] ;            /*A screen sized buffer*/
    static lv_color_t buf_3_2[1024 * 600] ;            /*Another screen sized buffer*/
